#создайте модель множественной линейной регрессии потоков дневных потоков паров воды за период 2013 года 
...
#оставим данные только по дневным измерениям 2013 года:
